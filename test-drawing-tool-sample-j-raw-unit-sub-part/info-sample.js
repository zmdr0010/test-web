const drwResInfoSample = {
  list: [
    {
      type: 'raw',
      target: 'rbxRawStringSampleUt00',
      targetType: 'list',
      obj: rbxRawStringSampleUt00
    },
    {
      type: 'color',
...
const drwObjLinkInfoSample = {
  uCode: '202403031135_drwObjLinkInfo-sample',
  uCodeType: 'string',
  ...
  cs: 30, // column size
  rawLink: {
    target: '', uCode: '', uCodeType: 'index'
  }, // uCodeType : index / string
  colorLinkList: [
    // { target: '', uCode: '', uCodeType: 'index' }
  ], // by rawNum
  child: [
    {
      uCode: '202403031135_drwObjLinkInfo-sample-f',
      uCodeType: 'string',
      memo: 'f', // front
      r: 9,
      c: 0,
    ...
    {
      uCode: '202403031135_drwObjLinkInfo-sample-l',
      uCodeType: 'string',
      memo: 'l', // left
      r: 0,
      c: 12,
    ...
    {
      uCode: '202403031135_drwObjLinkInfo-sample-r',
      uCodeType: 'string',
      memo: 'r', // right
      r: 18,
      c: 12,
    ...
    {
      uCode: '202403031135_drwObjLinkInfo-sample-bk',
      uCodeType: 'string',
      memo: 'bk', // back
      r: 9,
      c: 21,
    ...
    {
      uCode: '202403031135_drwObjLinkInfo-sample-bd',
      uCodeType: 'string',
      memo: 'bd', // body
      r: 6,
      c: 9,
...
const drwObjInfoSample = {
  uCode: '202403031135_drwObjInfo-sample',
  uCodeType: 'string',
  memo: 'drwObjInfo-sample',
  r: 0,
  c: 0,
  rs: 27,
  cs: 30,
...
const drwObjLinkInfoSample00 = {
  uCode: `202403031613_drwObjLinkInfo-sample`,
  uCodeType: 'string',
  memo: 'drwObj-sample',
  r: 0, // row
  c: 0, // column
