const sampleTempPartPresetInfoMain = {
  ...
  partInfo: {
    ...
    drwObjLink: "",
    moveSetLink: "sample-part-move-set-preset-info-sample-move-pattern-00",
    hitLink: "",
    effectLink: "",
    armsLink: "",
    child: [
      ...
      },
      {
        ...
        moveSetLink: "sample-part-move-set-preset-info-sample-idle-t-b-l",
        hitLink: "hit-link-info-obj-area",
        effectLink: "",
        armsLink: "",
        child: []
      },
      {
        ...
        moveSetLink: "sample-part-move-set-preset-info-sample-idle-t-b-r",
        hitLink: "hit-link-info-obj-area",
        effectLink: "",
        armsLink: "",
        child: []
